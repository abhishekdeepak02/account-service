...
@Tag(
        name = "Customer REST APIs for CRUD operations",
        description = "REST APIs for Lazy bank to FETCH customer details."
)
@RestController
...
public class CustomerController {
    ...
    @Operation(
            ...
            description = "REST API to fetch customer details in Lazy Bank."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
